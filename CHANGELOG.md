...
- 🐛 Report exactly which files and folders could not be read during folder setup and the initial merge, with a short reason, and let you continue while skipping them or cancel to fix access.
